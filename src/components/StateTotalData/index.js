...
class StateTotalData extends Component {
  ...
  getEachState = async () => {
    ...
    const confirmedData = {
      name: 'Confirmed',
      logo:
        'https://res.cloudinary.com/drytxchra/image/upload/v1661774685/check-mark_1_yctj1i.png',
    ...
    const activeData = {
      name: 'Active',
      logo:
        'https://res.cloudinary.com/drytxchra/image/upload/v1661774686/protection_1_zudke5.png',
      value: totalActive,
    }
    ...
    const recoveredData = {
      name: 'Recovered',
      logo:
        'https://res.cloudinary.com/drytxchra/image/upload/v1661774685/recovered_1_u9gaxm.png',
      value: totalRecovered,
    }
    const deceasedData = {
      name: 'Deceased',
      logo:
        'https://res.cloudinary.com/drytxchra/image/upload/v1661774684/breathing_1_bu3czh.png',
      value: totalDeceased,
    }
